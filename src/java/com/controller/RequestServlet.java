...
public class RequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("accept") != null ){
            ...
            sp.setCompanyname(cname);
            
            DAO acceptservicerovider = new DAO();
        try {
            acceptservicerovider.connection();
        } catch (Exception ex) {
            Logger.getLogger(RequestServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
            try {
                acceptservicerovider.acceptservicerovider(sp);
        ...
        if(request.getParameter("reject") != null ){
            ...
            DAO rejectservicerovider = new DAO();
        try {
            rejectservicerovider.connection();
        } catch (Exception ex) {
            Logger.getLogger(RequestServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
            try {
                rejectservicerovider.rejectservicerovider(sp);
                response.sendRedirect("RequestPage.jsp");
            } catch (SQLException ex) {
                Logger.getLogger(RequestServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
